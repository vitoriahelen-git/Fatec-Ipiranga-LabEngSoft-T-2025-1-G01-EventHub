...
const obterServicos = async () => {
  ...
  return (
    <>
      <Helmet>
          <title>Meus Serviços | EventHub</title>
      </Helmet>
              ...
              {exibirGuia && (
                <QuickGuide
                    passos={[
                    {
                        ...
                        detalhe: "Anuncie e divulgue seus serviços para milhares de organizadores de eventos.",
                        imagem: "/QuickGuide/bemvindo.png",
                    },
                    {
                        titulo: "Cadastrar um serviço",
                        detalhe: "Clique em 'Serviços' e depois em 'Criar Serviço' para criar seu primeiro serviço",
                        imagem:  "/QuickGuide/criar-servico.png",
                    },
                    {
                     titulo: "Anuncie seus serviços",
                     detalhe: "Após a criação de um serviço, você pode anunciar ele para que apareça publicamente no marketplace da plataforma, basta clicar em 'Anunciado' e inserir as informações a respeito da data de início e término do seu anuncio!",
                     imagem: "/QuickGuide/anunciar.png"
                    },
                    {
                      titulo: "Gerencie seus pedidos",
                      detalhe: "Na aba 'Pedidos' você acompanha as contratações de seus serviços e o status.",
                      imagem: "/QuickGuide/pedidos-prestador.png"
                    }
                    ]}
                    onClose={() => setExibirGuia(false)}
                    corPrincipal="var(--yellow-700)"
                    />
                    )}
          </div>}
      </div>
