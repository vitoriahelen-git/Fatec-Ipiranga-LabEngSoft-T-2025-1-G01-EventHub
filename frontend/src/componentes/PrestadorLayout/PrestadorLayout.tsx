    ...
    <div className="layout">
      ...
      <div className="layout-conteudo">
        <div className={`barra-layout ${minimizada ? 'barra-layout--fechada-mobile' : 'barra-layout--aberta-mobile'}`}>
          <BarraLateral cor={'var(--yellow-800'} corHoverMinimizar={'white'} corIconeHoverMinimizar={'var(--yellow-800)'} minimizada={minimizada} enviaMinimizada={guardarMinimizada}>
            {/* <ItemBarraLateral texto="Home" caminho="/" corSelecionado={"white"} corIconeTextoSelecionado="var(--yellow-800)">
            ...
            <ItemBarraLateral texto="Serviços" caminho="/prestador/meus-servicos" corSelecionado={"white"} corIconeTextoSelecionado="var(--yellow-800)">
            ...
            <ItemBarraLateral texto="Pedidos" caminho="/prestador/pedidos" corSelecionado={"white"} corIconeTextoSelecionado="var(--yellow-800)"> 
            ...
            <ItemBarraLateral corSelecionado={"white"} texto="Perfil" caminho="/prestador/meu-perfil" corIconeTextoSelecionado="var(--yellow-800)">
